                                            ...
                                            <tbody>
                                                ...
                                                // {
                                                    ...
                                                    while($row = mysqli_fetch_array($squery))
                                                    {
                                                        ...
                                                        echo '
                                                        <script>var nameq = ' . json_encode($nameq) . '; console.log("row",nameq)</script>
                                                        <tr>
                                            ...
                                            <tbody>
                                                ...
                                                // {
                                                    ...
                                                    while($row = mysqli_fetch_array($squery))
                                                    {
                                                        ...
                                                        echo '
                                                        <script>var nameq = ' . json_encode($nameq) . '; console.log("row2",nameq)</script>
                                                        
                                                        <script>console.log("id",'.$row['id'].')</script>
                                                        <tr>
                                                            <td><input type="checkbox" name="chk_delete[]" class="chk_delete" value="'.$row['id'].'" /></td>
                                                            <td>'.$row['id'].'</td>
                                                            <td>'.$nameq[0].' '.$nameq[1].'</td>
